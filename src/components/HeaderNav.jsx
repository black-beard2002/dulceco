    ...
    <nav className="w-full bg-white fixed z-50 h-[4.5rem] flex items-center font-poppins">
      <div className="w-full flex flex-row items-center justify-between px-4 md:px-12">
        <div className="flex flex-row gap-2 items-center">
          <h2 className="text-[#443] text-2xl font-poppins">DULCE & CO</h2>
          <FontAwesomeIcon icon={faCake} className="text-[#443] w-8 h-8" />
        </div>
        ...
        <div className="hidden md:flex flex-row gap-6">
          ...
          <a className={fixedClassName} href="#book">Order</a>
        </div>
      ...
      >
        ...
        <a className={fixedClassName}>Order</a>
